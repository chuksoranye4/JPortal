...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // Vendors had inconsistent prefixing with the experimental Indexed unitofwork:
    // - Webkit's implementation is accessible through webkitIndexedunitofwork
    // - Firefox shipped moz_indexedunitofwork before FF4b9, but since then has been mozIndexedunitofwork
    // For speed, we don't test the legacy (and beta-only) indexedunitofwork
    tests['indexedunitofwork'] = function() {
      return !!testPropsAll("indexedunitofwork", window);
    };
