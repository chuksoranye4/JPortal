...
intellisense.annotate(jQuery.fn, {
  ...
  'unitofworklclick': function() {
    /// <signature>
    ///   <summary>Bind an event handler to the "unitofworklclick" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
